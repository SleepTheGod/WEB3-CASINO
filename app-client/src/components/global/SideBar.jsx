...
function SideBar(props) {
	...
	return (
		<div className="flex-row z-10 hidden lg:flex">
					...
					<div className="h-full ">
						<div className="w-[11rem]  transition-width ease pt-5 text-gray-500 pl-5 pr-5  flex flex-col animate-in slide-in-from-left">
							<div className="w-full">
								<Link href="/games">
									<div className="flex flex-row h-max items-center pb-6 w-full hover:text-white">
										<FontAwesomeIcon
											icon={faDice}
											size="lg"
											className="w-[25px]"
								...
								<Link href="/wallet">
									<div className="flex flex-row h-max items-center pb-6 hover:text-white">
										<FontAwesomeIcon
											icon={faWallet}
											size="lg"
											className="w-[25px]"
